<#--
  ...
  https://yuroyami.github.io/Kite3D/ and https://github.com/yuroyami/Kite3D are substituted per repository by
...
<#macro display>
    <header class="navigation theme-dark" id="navigation-wrapper" role="banner">
        ...
        <nav class="kite-nav-links" aria-label="Kite documentation">
            <a href="https://yuroyami.github.io/Kite3D/">Guide</a>
            <a href="https://github.com/yuroyami/Kite3D">GitHub</a>
        </nav>
